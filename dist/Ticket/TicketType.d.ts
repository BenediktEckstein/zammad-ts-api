...
export type TicketExpansion = Record<string, string | string[] | number | number[]> | undefined;
export type ApiTicket<E extends TicketExpansion = undefined> = Expand<z.infer<typeof ticketSchema> & {
    [K in keyof E]: E[K];
}>;
export type ExpandedApiTicket<E extends TicketExpansion = undefined> = Expand<z.infer<typeof expandedTicketSchema> & {
    [K in keyof E]: E[K];
}>;
